const translations = {
    ...
    en: {
        ...
        noise_desc: "Two decades proving that metal has no gender. Our voice is guttural, our presence indelible. Against patriarchy, maximum volume. We are the queens of steel and we have come to shake the foundations.",
        activities_title: "ACTIVITIES",
        act_fascismo_title: "METAL AGAINST FASCISM",
        act_fascismo_desc: "A conversation about history, resistance, and activism within the extreme scene.",
        act_fascismo_speakers_title: "A conversation with:",
        act_fascismo_speakers: "Raquel García<br><small>(photographer and founder of Rockin' Ladies)</small><br>Emilio Casal<br><small>(Bocc, Tugurio and Veratre)</small><br>and moderated by Sol",
        ...
        maldo_desc: "Graphic project by Marta Maldonado (Maldo) focused on the editorial and musical world. Through oil and ink, she merges nature, mythology, metal, and darkness.",
        ultrachains_desc: "From Madrid comes this handmade stainless steel jewelry project. Chainmail pieces inspired by punk aesthetics and created by hand.",
        mda_desc: "Collective that organizes punk concerts, talks, and distributes materials under the banner of self-management. Good books, fanzines, and music.",
        corv_desc: "Project that bets on self-management and creative recycling. From screen-printed patches to accessories with recovered materials.",
        marica_desc: "Illustration and tattoo that explores and questions systems of oppression, visualizing forms of resistance. Emancipated and defiant characters.",
        susana_desc: "Illustrator and fanzine editor focused on psycho-heavy imagery and musical graphics, with a strong vindictive component.",
        flamigera_desc: "Hand-intervened clothing and screen printing project that recreates the imagery of metal and punk bands under its own style.",
        help_title: "CAN YOU GIVE US A HAND?",
        help_desc: "We are looking for people for the work team. Without you, this would not be possible. Are you up for a shift?",
        role_bar: "BAR",
        role_stage: "STAGE",
        role_access: "ACCESS",
